...
/**
 * Hiển thị 1 comment gốc + danh sách reply của nó (1 cấp, không lồng tiếp).
 *
 * Props:
 * - comment (object)
 * - postId (number)
 * - onReplyAdded (fn) — callback khi reply được tạo
 * - onCommentDeleted (fn?) — callback khi xóa (parent xóa khỏi list)
 * - onCommentUpdated (fn?) — callback khi sửa (parent cập nhật list)
 *
 * Comment do Groq AI tạo ra (isAiGenerated=true) có style riêng.
 * Nếu user hiện tại là chủ comment → hiện nút Edit / Delete.
 */
export default function CommentItem({
 ...
 // Live state cho content hiển thị (cập nhật sau khi edit)
 ...
 {/* Replies — lồng 1 cấp, thụt vào trái */}
...
/** Reply hiển thị gọn hơn, không có nút Reply (chỉ lồng 1 cấp) */
