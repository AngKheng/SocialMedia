...
/**
 * FeedPage gồm 2 tab (Phase 9I):
 * - "feed": bài của người đang follow + chính mình (có phân trang)
 * - "discover": random bài từ người không follow (làm mới = lấy random mới)
 *
 * Khi đang search (có query >= 2 ký tự) thì 2 tab ẩn, hiện kết quả search.
 */
export default function FeedPage() {
 ...
 try {
 const res = await api.get("/posts/discover", { params: { limit: 20 } });
 setDiscoverPosts(res.data);
 } catch (err) {
 console.error("Load discover thất bại:", err);
 } finally {
 ...
 Bài viết ngẫu nhiên từ người bạn chưa follow.
 </p>
 <button
 ...
 >
 {discoverLoading ? "Đang tải..." : "🔄 Làm mới"}
 </button>
 </div>
 ...
 Chưa có bài viết nào để khám phá. Hãy follow thêm người dùng hoặc quay lại sau!
 </p>
 )}
